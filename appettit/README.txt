...
a persistence unit "appettitPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "appettit\pom.xml":
...
artifacts ("appettit-ejb.jar" and "appettit-web.war") are already built. You can build
