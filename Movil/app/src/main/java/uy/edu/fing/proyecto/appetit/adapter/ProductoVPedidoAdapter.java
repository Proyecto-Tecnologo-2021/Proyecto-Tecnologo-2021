...
public class ProductoVPedidoAdapter extends BaseAdapter {
    private static final String TAG = "ProductoVPedidoAdapter";
    private Context context;
    private List<Object> productos;

    public ProductoVPedidoAdapter(Context context, List<Object> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.producto_vlist_item, null);
        }
